///Users/malmobarak001/All_Vscode/myprojectforbooks/frontend/src/components/ChatBot/chatbot.tsx
...
const Chatbot: FC = () => {
  ...
  const toggleChat = (): void => setShowChat(!showChat);
  ...
  return (
    <>
      ...
      <Chat isVisible={showChat} closeChat={() => setShowChat(false)} />
    </>
  );
};
