...
const ProfileIcon: FC = () => {
  ...
  const handleLogoutClick = () => {
    ...
    console.log('Token removed:', localStorage.getItem('access_token') === null); 
  };
    ...
    <div className={styles['profile-container']}>
      <button className={styles['profile-button']} onClick={handleProfileClick}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <mask id="mask1_85_14234" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="6" y="2" width="12" height="11">
            <path fillRule="evenodd" clipRule="evenodd" d="M6.60986 2.00012H17.2299V12.6187H6.60986V2.00012Z" fill="white"/>
          </mask>
          <g mask="url(#mask1_85_14234)">
      ...
      {showMenu && (
        <div className={styles['profile-dropdown']}>
          <button onClick={handleLoginClick}>Sign In Log In</button>
